...
import KeyPlayersItem from "@/components/Book/KeyPlayersItem";
import TableOfContent from "@/components/Book/TableOfContent";
  ...
  <Fragment>
    <div className="bg-gray-100 min-h-screen mt-8 px-4 sm:px-8 lg:px-16">
        ...
        <div className="w-[70%] flex flex-row gap-12">
          ...
          <div className="text-black text-[18px] font-light flex flex-col gap-4 mr-12 w-[80%]">
            <p>
              ...
              Semiconductors industry is a rapidly evolving sector, projected to
              reach a value of USD 112.7 billion by 2032, growing at a Compound
              Annual Growth Rate (CAGR) of 6.27% from 2023 to 2032.
            </p>
            <p>
          ...
          <div className="w-[90%]">
            <ul className="space-y-2 text-gray-700">
              ...
              <li className="flex justify-between">
                ...
                <span className="w-[65%] text-[12px] text-black">English</span>
              </li>
              <li className="flex justify-between">
                <span className="font-normal text-[#7F7F7F] text-[12px]">
                  Published:
              ...
              <li className="flex justify-between">
                ...
                <span className="w-[65%] text-[12px] text-black">
                  $112.7 Billion <span className="text-[#7F7F7F]">(2023)</span>
                </span>
              </li>
              <li className="flex justify-between">
                <span className="font-normal text-[#7F7F7F] text-[12px]">
      ...
      <div className="flex flex-row items-center justify-between mb-6">
        <p className="text-black text-[26px] font-normal">TABLE OF CONTENTS</p>
        <button className="px-4 py-2 text-[#0DAFBF] bg-white border border-[#0DAFBF] rounded-[5px] uppercase font-normal text-[14px] flex flex-row items-center">
          <div className="w-[18px] h-[18px] mr-2">
            <Image
        ...
        <div className="mt-16">
          <div className="grid grid-cols-3 gap-8">
            {keyPlayersItemData.map((data, idx) => (
              <KeyPlayersItem key={idx} image={data.image} title={data.title} />
            ))}
          </div>
        </div>
      </div>
