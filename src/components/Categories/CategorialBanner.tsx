  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row gap-4 w-full lg:w-[45%]">
        <div className="bg-white cursor-pointer flex items-center lg:items-end w-[150px] h-[85px] lg:w-[254px] lg:h-[95px] rounded-[14px] transform transition-transform duration-300 hover:-translate-y-2">
        ...
        <div className="border-solid cursor-pointer flex  items-center lg:items-end w-[150px] h-[85px] border-[1px] border-white rounded-[14px] lg:w-[254px] lg:h-[95px] transform transition-transform duration-300 hover:-translate-y-2">
          <div className="flex flex-row items-center p-6 lg:px-8 lg:py-6">
